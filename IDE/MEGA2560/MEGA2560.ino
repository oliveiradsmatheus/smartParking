...
int DistanciaAtivacao = 30, TempoAnalise = 6; // cm , seg
...
void SetLed(int LED_R, int LED_Y, int LED_G, int TempoVaga[], int Distancia, int idSensor[], int index)
{
	...
	if (TempoVaga[index] <= 0 && Distancia > DistanciaAtivacao) {	  // Vaga Disponivel
	...
	else if (TempoVaga[index] < TempoAnalise && Distancia < DistanciaAtivacao) {	// Vaga em Analise
